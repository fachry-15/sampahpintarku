    ...
    <div class="w-full lg:ps-64 ">
        ...
        <ol class="flex items-center whitespace-nowrap">
            ...
            <li class="inline-flex items-center text-sm font-semibold text-gray-800 truncate dark:text-neutral-200" aria-current="page">
              Daftar Histori Sampah
            </li>
          </ol>
        <div class="text-left py-4">
            <h1 class="text-6xl font-extrabold text-gray-800 dark:text-neutral-200">Histori Debit Sampah</h1>
            <p class="mt-2 text-sm font-normal text-gray-500 dark:text-neutral-400">Berikut adalah daftar histori debit sampah organik dan anorganik yang telah tercatat dalam sistem.</p>
        </div>
