<x-guest-layout>
  ...
  <main id="content">
  <!-- Hero -->
  <div class="bg-neutral-900 dark:bg-white">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-40 space-y-8">
      <!-- announcement banner -->
      <div class="flex justify-center">
        <a class="group inline-flex items-center bg-white/10 dark:bg-neutral-900 hover:bg-white/20 dark:hover:bg-neutral-800 border border-white/10 dark:border-neutral-700 p-1 ps-4 rounded-full shadow-md focus:outline-none focus:bg-white/20 dark:focus:bg-neutral-800" href="../figma.html">
          <p class="me-2 text-white dark:text-neutral-200 text-sm">
            Sampah Pintarku
          </p>
          <span class="group-hover:bg-white/20 dark:group-hover:bg-neutral-800 py-1.5 px-2.5 flex justify-center items-center gap-x-2 rounded-full bg-white/10 dark:bg-neutral-900 font-semibold text-white dark:text-neutral-200 text-sm">
      ...
      <div class="max-w-3xl text-center mx-auto">
        <h1 class="block font-bold text-gray-200 dark:text-neutral-900 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
          Mari Ubah Tempat Sampah Anda
        </h1>
      </div>
      <!-- end title -->

      <div class="max-w-3xl text-center mx-auto">
        <p class="text-lg text-white/70 dark:text-neutral-700">
          Ayo, jadikan lingkungan kita lebih bersih dan cerdas dengan menggunakan Sampah Pintarku solusi inovatif untuk pengelolaan sampah yang lebih baik.
        </p>
      </div>

      <!-- buttons -->
      <div class="text-center">
        <a class="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-r from-yellow-400 to-yellow-500 dark:from-yellow-500 dark:to-yellow-600 shadow-lg hover:shadow-yellow-400/50 dark:hover:shadow-yellow-300/50 border border-yellow-300/30 text-black text-sm font-semibold rounded-full focus:outline-none focus:ring-2 focus:ring-yellow-400 py-3 px-6 transition-all duration-300" href="#">
          Lihat Lebih Lanjut
          <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentcolor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="m9 18 6-6-6-6"/>
          </svg>
  ...
  <!-- end hero -->
    ...
    <!-- Case Stories -->
    <div class="bg-neutral-900 bg-gradient-to-t from-black to-transparent dark:bg-white dark:bg-gradient-to-t dark:from-white dark:to-transparent">
      <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-white dark:text-neutral-900 font-bold text-2xl md:text-4xl md:leading-tight mb-4">Kenapa Harus Pakai Tempat Sampahku ?</h2>
          <p class="mt-1 text-neutral-400">
            Tempat sampah pintar kami membantu mengurangi limbah dan meningkatkan efisiensi pengelolaan sampah. Dilengkapi dengan teknologi canggih untuk pemantauan real-time, memudahkan Anda menjaga kebersihan lingkungan.
          </p>
        </div>
        <!-- End Title -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
          ...
          <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
            <div class="mb-5">
              ...
              <div class="mt-5">
                ...
                <h3 class="mt-5 font-medium text-lg text-white">Jangka Panjang</h3>
                <p class="mt-1 text-neutral-400">
                    Hanya dengan membayar satu kali, pengontrolan sampah Anda akan menjadi lebih efisien dan lebih praktis, membantu menjaga kebersihan lingkungan dengan lebih mudah dan teratur.
                </p>
              </div>
            </div>
            <p class="mt-auto">
          ...
          <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
            <div class="mb-5">
              ...
              <div class="mt-5">
                <h3 class="mt-5 font-medium text-lg text-white">Sistem Terintegrasi</h3>
                <p class="mt-1 text-neutral-400">Sistem terintegrasi memudahkan informasi dan pemantauan pengumpulan sampah secara real-time, memungkinkan penjadwalan yang lebih efisien dan respons cepat terhadap kebutuhan pengelolaan sampah.</p>
              </div>
            </div>
            <p class="mt-auto">
              <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] transition focus:outline-none group-focus:border-[#ff0]">
          ...
          <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100" href="#">
            <div class="mb-5">
              ...
              <div class="mt-5">
                <h3 class="mt-5 font-medium text-lg text-white">Mudah Digunakan</h3>
                <p class="mt-1 text-neutral-400">Sistem ini telah diterapkan pada website yang fleksibel dan dapat Anda pantau melalui telepon genggam Anda secara langsung, memberikan kemudahan dan kenyamanan dalam mengelola sampah kapan saja dan di mana saja.</p>
              </div>
            </div>
            <p class="mt-auto">
              <span class="font-medium text-sm text-[#ff0] pb-1 border-b-2 border-neutral-700 group-hover:border-[#ff0] transition focus:outline-none group-focus:border-[#ff0]">
    ...
    <div class="bg-neutral-100 dark:bg-neutral-900">
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-neutral-900 dark:text-white font-bold text-2xl md:text-6xl md:leading-tight mb-4">Tentang Kami</h2>
          <p class="mt-1 text-neutral-700 dark:text-neutral-400">Kenali lebih dalam tentang kami dan temukan bagaimana solusi tempat sampah pintar kami dapat membantu menciptakan lingkungan yang lebih bersih dan efisien. Tempat sampah pintar kami dirancang dengan teknologi canggih yang memungkinkan pemantauan dan pengelolaan sampah secara real-time. Dengan fitur-fitur seperti sensor pengisian, notifikasi otomatis, dan analisis data, kami membantu mengurangi limbah dan meningkatkan efisiensi pengelolaan sampah. Kami berkomitmen untuk memberikan solusi yang ramah lingkungan dan mudah digunakan, sehingga setiap orang dapat berkontribusi dalam menjaga kebersihan lingkungan. Bergabunglah dengan kami dalam menciptakan masa depan yang lebih hijau dan bersih.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
          <div>
            <!-- Blockquote -->
            <blockquote>
            <p class="font-medium text-xl text-neutral-900 dark:text-white md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                "Satu tindakan kecil untuk lingkungan, seperti membuang sampah pada tempatnya, dapat memberikan dampak besar bagi kelestarian bumi."
            </p>
              ...
              <footer class="mt-6">
                <div class="flex items-center">
                  ...
                  <div class="ms-4 md:ms-0">
                    <div class="text-base font-semibold text-white">Fachry Rizky Prasetya</div>
                    <div class="text-xs text-neutral-400">Developer of Tempat Sampahku</div>
                  </div>
                </div>
              </footer>
            </blockquote>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
              ...
              <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                ...
                <div class="mt-3 sm:mt-5">
                  <h3 class="text-lg sm:text-3xl font-semibold text-white">2024</h3>
                  <p class="mt-1 text-sm sm:text-base text-neutral-400">Berdiri sejak</p>
                </div>
              </div>
              <!-- End Stats -->
              ...
              <div class="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                ...
                <div class="mt-3 sm:mt-5">
                  <h3 class="text-lg sm:text-3xl font-semibold text-white">1</h3>
                  <p class="mt-1 text-sm sm:text-base text-neutral-400">Mitra Komplek</p>
                </div>
              </div>
              <!-- End Stats -->
    ...
    <div class="bg-neutral-100 dark:bg-neutral-900">
      ...
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-neutral-900 dark:text-white font-semibold text-2xl md:text-4xl md:leading-tight">Langkah menggunakan Sampah Pintarku.</h2>
            <p class="mt-1 text-neutral-400">Mari ikuti langkah-langkah berikut untuk menggunakan Sampah Pintarku.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          ...
          <div>
            <!-- Heading -->
            <div class="mb-4">
              <h3 class="text-xs font-medium uppercase text-neutral-900 dark:text-[#ff0]">
                Langkah Pendaftaran
              </h3>
            </div>
            <!-- End Heading -->
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="relative last:after:hidden after:absolute after:top-8 after:bottom-0 after:start-4 after:w-px after:-translate-x-[0.5px] after:bg-neutral-800">
                <div class="relative z-10 size-8 flex justify-center items-center">
                  <span class="flex flex-shrink-0 justify-center items-center size-8 border border-neutral-800 text-neutral-900 dark:text-[#ff0] font-semibold text-xs uppercase rounded-full">
                    1
                  </span>
                </div>
              </div>
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm lg:text-base text-neutral-500 dark:text-neutral-400">
                  <span class="text-neutral-900 dark:text-yellow-300 font-semibold">Pendaftaran Akun:</span>
                  Lengkapi formulir pendaftaran di bawah ini atau gunakan akun Google Anda untuk mendaftar dengan cepat dan mudah.
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm lg:text-base text-neutral-400">
                  <span class="text-neutral-900 dark:text-white font-semibold">Lengkapi Informasi Data:</span>
                    Lengkapi data alamat, nomor telepon, dan informasi terkait untuk kebutuhan kelengkapan data sampah.
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm md:text-base text-neutral-400">
                  <span class="text-neutral-900 dark:text-white font-semibold">Pilih layanan:</span>
                    Pilih layanan yang ingin digunakan pada layanan Sampah Pintarku sesuai kebutuhan Anda. Setelah memilih, tunggu hingga konfirmasi dari pihak admin dan pilih penjadwalan pengambilan.
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm md:text-base text-neutral-400">
                  <span class="text-neutral-900 dark:text-white font-semibold">Proses aktivasi sistem:</span>
                    Proses aktivasi dan perakitan dilakukan oleh tim terbaik Sampah Pintarku sesuai jadwal yang Anda pilih dan Sampah Pintarku siap Anda gunakan.
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#ff0] font-medium text-sm text-neutral-800 rounded-full focus:outline-none transition duration-300 ease-in-out transform hover:scale-105 hover:bg-[#ff0]/80" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672ZM12 2.25V4.5m5.834.166-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243-1.59-1.59" />
              </svg>
              Klik untuk mulai menggunakan Sampah Pintarku
            </a>
          </div>
          <!-- End Timeline -->
        </div>
    ...
    <!-- Hero -->
<div class="relative bg-neutral-900 dark:bg-white">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <!-- Grid -->
      <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
        <div>
            <p class="inline-block text-sm font-medium bg-clip-text text-neutral-200 dark:text-neutral-900">
              Sampah Pintarku - <span class="text-yellow-500 dark:text-yellow-400"> Solusi Tempat Sampah Pintar</span>
            </p>
  
          <!-- Title -->
          <div class="mt-4 md:mb-12 max-w-2xl">
            <h1 class="mb-4 font-bold text-neutral-200 text-2xl lg:text-4xl dark:text-neutral-900">
                Bergabunglah dengan Kami dan Mulai Pengelolaan Sampah Pintar Anda!
            </h1>
            <p class="text-gray-600 dark:text-neutral-600">
                Bergabunglah dengan kami hari ini dan ambil langkah pertama menuju lingkungan yang lebih cerdas dan bersih. Solusi pengelolaan sampah inovatif kami dirancang untuk membuat hidup Anda lebih mudah dan efisien.
            </p>
          </div>
          <!-- End Title -->
        </div>
          ...
          <form>
            <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
              ...
              <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-neutral-900">
                <div class="text-center">
                  <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Mari Bergabung </h1>
                  <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                    Sudah punya akun?
                    <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="#">
                      Masuk disini
                    </a>
                  </p>
                </div>
                ...
                <div class="mt-5">
                  <a href="{{ route('google.login') }}" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800">
                  ...
                  <div class="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-700 dark:after:border-neutral-700">Atau</div>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <label for="hs-hero-signup-form-floating-input-first-name" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                          ...
                          peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Nama Depan</label>
                      </div>
                      <!-- End Floating Input -->
                    </div>
                    <!-- End Input Group -->
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <label for="hs-hero-signup-form-floating-input-last-name" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                          ...
                          peer-[:not(:placeholder-shown)]:translate-x-0.5
                          peer-[:not(:placeholder-shown)]:-translate-y-1.5
                          peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Nama Belakang</label>
                      </div>
                      <!-- End Floating Input -->
                    </div>
                    <!-- End Input Group -->
                    ...
                    <div class="col-span-full">
                      ...
                      [&:not(:placeholder-shown)]:pb-2
                      autofill:pt-6
                      autofill:pb-2" placeholder="email@example.com">
                    ...
                    <div class="relative col-span-full">
                      ...
                      <label for="hs-hero-signup-form-floating-input-new-password" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Kata Sandi</label>
                      </div>
                      <!-- End Floating Input -->
                  ...
                  <!-- End Grid -->
                    <div class="mt-5">
                    <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-[#ff0] text-neutral-800 hover:bg-[#ff0]/80 focus:outline-none focus:bg-[#ff0]/80 transition duration-300 ease-in-out">Daftar Akun</button>
                    </div>
                </div>
              </div>
              <!-- End Card -->
      ...
      <!-- Clients Section -->
      <div class="mt-6 md:mt-12 py-3 flex items-center text-sm text-neutral-200 dark:text-neutral-900 gap-x-1.5 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:after:border-neutral-700">
        <div class="flex items-center gap-x-2">
          <span>© 2021 Sampah Pintarku. All rights reserved.</span>
        </div>
        <div class="flex items-center gap-x-2">
